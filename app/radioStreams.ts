...
export const playListData: Track[] = [
  {
    ...
    artwork: Image.resolveAssetSource(
      require('./assets/album-art/cristal101.1-albumart.png'),
    ).uri,
  ...
  },
  {
    ...
    artist: 'Grupo Radar',
    artwork: Image.resolveAssetSource(
      require('./assets/album-art/elyella103.7-albumart.png'),
    ).uri,
  ...
  },
  {
    ...
    artist: 'Grupo Radar',
    artwork: Image.resolveAssetSource(
      require('./assets/album-art/radar107.5-albumart.png'),
    ).uri,
  ...
  },
  {
    ...
    artist: 'Grupo Radar',
    artwork: Image.resolveAssetSource(
      require('./assets/album-art/cristal96.7-albumart.png'),
    ).uri,
  ...
  },
  {
    ...
    artist: 'Grupo Radar',
    artwork: Image.resolveAssetSource(
      require('./assets/album-art/lobobajio88.1-920am-albumart.png'),
    ).uri,
  ...
  },
  {
    ...
    artist: 'Grupo Radar',
    artwork: Image.resolveAssetSource(
      require('./assets/album-art/lobo88.3-albumart.png'),
    ).uri,
  ...
  },
  {
    ...
    artist: 'Grupo Radar',
    artwork: Image.resolveAssetSource(
      require('./assets/album-art/radar88.9-albumart.png'),
    ).uri,
